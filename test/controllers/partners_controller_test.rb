...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: { name: @partner.name, partner_code: @partner.partner_code, status: @partner.status }
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: { name: @partner.name, partner_code: @partner.partner_code, status: @partner.status }
    assert_redirected_to partner_path(assigns(:partner))
  end
