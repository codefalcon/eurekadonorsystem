...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { districtIdentifier: @district.districtIdentifier, name: @district.name, status: @district.status }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { districtIdentifier: @district.districtIdentifier, name: @district.name, status: @district.status }
    assert_redirected_to district_path(assigns(:district))
  end
